 ...
 */
export const animateTo = (el: Element, keyframes: Keyframe[], options?: KeyframeAnimationOptions) => {
 ...
 */
export const stopAnimations = (el: Element) => {
	return Promise.all(
 ...
 * .
 */
export const shimKeyframesHeightAuto = (keyframes: Keyframe[], calculatedHeight: number) => {
